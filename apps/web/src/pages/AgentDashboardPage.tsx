        ...
        {agent.profileStrength < 100 && (
          <div className="bg-amber-500/5 border border-amber-500/20 rounded-xl p-4 mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-warm-50 text-sm font-medium">Your profile is {agent.profileStrength}% complete</p>
                <p className="text-gray-500 text-xs">Complete profiles get more visibility and artist bookings</p>
              </div>
            </div>
            <button
              onClick={openEditModal}
